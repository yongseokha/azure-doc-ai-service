...
def _build_index() -> SearchIndex:
    return SearchIndex(
        ...
        fields=[
            ...
            SimpleField(name="total_cache_write_tokens", type=SearchFieldDataType.Int32),
            SimpleField(name="llm_call_count", type=SearchFieldDataType.Int32),
    ...
    await _merge_or_upload(
        {
            ...
            "total_cache_write_tokens": usage.totalCacheWriteTokens,
            "llm_call_count": usage.llmCallCount,
            "total_elapsed_seconds": usage.totalElapsedSeconds,
            "avg_elapsed_seconds": usage.avgElapsedSeconds,
            "updated_at": _now_iso(),
